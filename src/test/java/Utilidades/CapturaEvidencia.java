...
public class CapturaEvidencia {
	...
	public static void escribirEnDocumento(String nombreDocumento, String tituloEvidencia, int fontSize) throws IOException, InvalidFormatException, InterruptedException {
		File fichero = new File(nombreDocumento); 
		XWPFDocument docx;
